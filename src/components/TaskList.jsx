...
const TaskList = () => {
  ...
  return (
    <div className="pb-20 mb-20">
      ...
      <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-white shadow-none pb-12 mb-12">
        <form
        ...
        >
          <div className="flex flex-col pb-2 mb-2">
            <div className="relative h-full w-full pb-1 mb-1">
              <input
